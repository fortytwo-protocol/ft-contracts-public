...
interface IFTMarketV2 is IERC6909Metadata, IERC6909TokenSupply {
    ...
    function seed(uint256[] calldata tokenIds, uint256[] calldata otAmounts, bytes calldata dataSwap)
        external
        returns (uint256 collateralConsumed);
    ...
    /**
     * @notice new function signature, not supported in IFTMarket
     */
